      ...
      <div className='flex flex-col  justify-center items-center border border-gray-200 rounded p-10 mt-4 w-[70%]'>
        <div className='flex flex-col justify-center items-center '>
          <div className='mb-4 flex flex-col justify-center items-center'>
            <img className="w-40 h-40 rounded-full" src={internship.companyLogo?.secure_url} alt='Company Logo' />
          </div>
        ...
        <div className='mt-5 w-[100%]'>
          ...
          <div className='flex'>
        <div className='flex'>
          <h4 className="text-2xl font-semibold text-black px-4">Internship Starting Date:</h4>
          <p className="flex items-start">{new Date(internship.startDate).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
        </div>
        <div className='flex'>
          <h4 className="text-2xl font-semibold text-black px-4">Internship Ending Date:</h4>
          <p className="flex items-start">{new Date(internship.endDate).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
        </div>
      </div>
